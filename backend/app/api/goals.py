...
async def list_goals(
    ...
    return await svc.list_goals(status=status, date_from=from_date, date_to=to_date)
...
async def get_goal(
    ...
    return await svc.get_goal(str(goal_id))
...
async def update_goal(
    ...
    return await svc.update_goal(str(goal_id), payload)
...
async def complete_goal(
    ...
    return await svc.complete_goal(str(goal_id))
